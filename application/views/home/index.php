  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <div class="navbar-nav ml-auto" style="font-family: Viga">
        <a class="nav-item nav-link" style="text-transform: capitalize;" href="<?= base_url(); ?>">Dashboard <span class="sr-only">(current)</span></a>
        <a class="nav-item nav-link" style="text-transform:capitalize" href="#">Komponen</a>
        <a class="nav-item nav-link" style="text-transform:capitalize" href="#">MyDemo</a>
      </div>
    </div>
  </nav>
</div>
